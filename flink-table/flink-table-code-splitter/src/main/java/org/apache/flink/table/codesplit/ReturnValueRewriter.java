 ...
 * <pre><code>
 * public class Example {
 *     int codeSplitReturnValue$0;
 *
 *     public int myFun(int a) {
 *         myFun_impl(a);
 *         return codeSplitReturnValue$0;
 *     }
 *
 *     void myFun_impl(int a) {
 *         a += 1;
 *         {
 *             codeSplitReturnValue$0 = a;
 *             return;
 *         }
 *     }
 * }
...
public class ReturnValueRewriter implements CodeRewriter {
    ...
    private class OuterVisitor extends JavaParserBaseVisitor<Void> {
        ...
        public Void visitMethodDeclaration(JavaParser.MethodDeclarationContext ctx) {
            ...
            newFields.peek().append(String.format("%s %s;", type, returnVarName));
