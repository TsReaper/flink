...
public class AddBooleanBeforeReturnRewriterTest
    ...
    public void testAddBooleanBeforeReturn() {
        ...
        Assert.assertEquals("codeSplitHasReturned$0", result.get(0).get("fun1(int a)"));
        Assert.assertEquals("codeSplitHasReturned$1", result.get(0).get("fun2(String b)"));
    }
    ...
    public void testRewriteInnerClass() {
        ...
        Assert.assertEquals("codeSplitHasReturned$0", result.get(0).get("fun(int a)"));
        Assert.assertEquals(1, result.get(1).size());
        Assert.assertEquals("codeSplitHasReturned$1", result.get(1).get("fun(int a)"));
        Assert.assertEquals(1, result.get(2).size());
        Assert.assertEquals("codeSplitHasReturned$2", result.get(2).get("fun(int a)"));
    }
